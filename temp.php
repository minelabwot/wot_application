...
//$url='http://121.42.31.195:9071/WIFPa/ResourceData.xml/0001000054f08cfa?ResourceID=3';
...
<body style="margin-top:25px">
 <div class="button blue"  onclick="location.reload();" ><div class="shine"></div>refresh</div> <br/><br/> <br/>
    </body>


    <body>
        <div class="nature" id="time">
           <span id="t1"></span>
        </div>
    <div  class="nature" id="d0">
        The Curren Temp is：<span id="d1"></span>°C
    </div>
   ...
   <script  type="text/javascript">
      function wendu(){
       sessionStorage.temp="<?php echo $tmp;?>";
          ...
          //document.getElementById("d1").innerHTML=21;
      }//温度获取函数
          window.onload=wendu();
        </script>      
     <div class="nature"> <a href="http://1.lixiaopengtest.sinaapp.com/oauth2_openid.php">Back To Device List</a></div> 
</body>
